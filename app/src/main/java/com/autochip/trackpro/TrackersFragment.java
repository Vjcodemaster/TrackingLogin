 ...
 * Use the {@link TrackersFragment#newInstance} factory method to
...
public class TrackersFragment extends Fragment {
    ...
    TrackerRecyclerVAdapter trackerRecyclerVAdapter;
     ...
     * @return A new instance of fragment TrackersFragment.
     */
...
*/
    private void init(View view){
        recyclerView = view.findViewById(R.id.rv_trackers_list);
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(getActivity());
        mLinearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(mLinearLayoutManager);
        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL));
        recyclerView.setHasFixedSize(true);
        trackerRecyclerVAdapter = new TrackerRecyclerVAdapter(getActivity(), alID, alName);
        recyclerView.setAdapter(trackerRecyclerVAdapter);
    }
    @Override
